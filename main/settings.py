...
SECRET_KEY = 'c7wmn(60(xe5-(hz-#!4i*)fy6^e22z7kj$g#qbffnz@8a%1$p'
...
INSTALLED_APPS = [
    ...
    'CRUDs.precificacao.apps.PrecificacaoConfig',
    ...
    'CRUDs.vendas.apps.VendasConfig',
    'CRUDs.vendasItens.apps.VendasItensConfig',
]
