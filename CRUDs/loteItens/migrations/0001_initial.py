    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantidade', models.DecimalField(decimal_places=2, max_digits=6, verbose_name='Quantidade')),
                ...
                ('produto', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='precificacao.precificacao', verbose_name='Produtos')),
